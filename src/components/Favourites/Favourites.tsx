    ...
    <div className='favorites-container'>
        ...
        {data !== null ? 
            <>
                ...
                <a href='/'>
                <button className='clear-btn' onClick={handleClick}>Clear Favourites</button>
                </a>
            </>
        : 
        <div className='no-fav'>
            <p>YOU DO NOT HAVE ANY FAVOURITE SONGS</p>
            <h2 className='sub-head'>TIP : You can dubble click on a song to add it to favourites</h2>
        </div>
        }
    </div>
  )
